...
- **Next:** P0-1 durable rate limiting, then P0-4 production dependency remediation. All other backlog items remain open. Sessions are still stateless until P1-3; clearing the cookie does not yet revoke a copied token server-side.
